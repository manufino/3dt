...
// - Overlay font: the embedded 5x7 dot-matrix font shared with the macOS
//   backend (src/bitmap_font.*), expanded to 8x16 cells at runtime - no
//   font libraries.
...
// The embedded 5x7 font shared with the macOS backend (src/bitmap_font.*),
